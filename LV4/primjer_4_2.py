...
#Zadatak 2:
# Razlika izlazas kodova je to što koriste drugačije predikcije i dugačije razine pronalaženja pogreške (MSE)
# jer koriste drugačije modele za prilagodbu nad podatcima